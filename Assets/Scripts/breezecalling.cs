...
public class breezecalling : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Player")) // if player hits the trigger box, it play the audio.
        {
            ...
            manager.GetComponent<audiomanager>().breezecall(); //send message to audiomanager object to play sound smoothly. Otherwise it will stop because of destroy() below. I was tried to give audiosource as parameter. But it doesn't work. SO I just call the method.
